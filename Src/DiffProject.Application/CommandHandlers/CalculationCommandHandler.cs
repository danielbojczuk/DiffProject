...
namespace DiffProject.Application.CommandHandlers
{
    ...
    ///</summary>
    public class CalculationCommandHandler : AbstractCommandHandler<ComparisonResultCommand, ComparisonResultResponse>
    {
        ...
        public override async Task<ComparisonResultResponse> Handle(ComparisonResultCommand command, CancellationToken cancellationToken)
        {
