...
namespace DiffProject.Application.CommandHandlers
{
    ...
    ///</summary>
    public class GetCalculationResultCommandHandler : AbstractCommandHandler<GetComparisonResultCommand, CalculationResponse>, IRequestHandler<GetComparisonResultCommand, CalculationResponse>
    {
        ...
        public override async Task<CalculationResponse> Handle(GetComparisonResultCommand command, CancellationToken cancellationToken)
        {
